...
knitr::opts_knit$set(root.dir = "/media/vera/big_data/coriandR/output/120517.median/")
...
karyotype = function(bands) {
  ...
  #karyotype_to_report$Chr = sub(c(unique(sort(karyotype_to_report$Chr, method = "shell"))),
...
plot_bins_regions_ideogram <- function(bin_data, cytobands, region_merged,
  ...
  plot_patient <- qplot(x, y) +
    ...
    #das eigentliche ideogram
                  geom_rect(data = cytobands[cytobands$Chr == chrn, ],
                    ...
                    aes(NULL, NULL, xmin = Start, xmax = End, fill = Band.type),
                        ymin = 0, ymax = 0.08, color = "gray", size = 0.5, alpha = 0.4) +
    ...
    # die regione einzeichnen
                  ...
                  x = "Regions", y = "log10 Mappable Reads")
  print(plot_patient)
  return(plot_patient)
}
