...
knitr::opts_knit$set(root.dir = "/home/vera/coriandR/output/98217.new.report_2/")
...
pon = whithin(pon, aberration = factor(ifelse(patient.norm > norm.clean.median & gauss.adjust < 0.05, 'amp', ifelse(patient.norm < norm.clean.median & gauss.adjust < 0.05), 'del', 'normal')), levels = c('normal', 'amp', 'del'))
# untested!
```
