...
```{r, PON gender segregation, echo = FALSE, warning=F}
pon$ploidy = 2
...
#plot(pon$bin, pon$mean, ylim = c(0, qnorm(0.999, mean(pon$mean), sd(pon$mean)), na.rm=TRUE),
#     col = "#11111111", pch = 16, 
...
```{r, Overview blocked bins, echo = FALSE, fig.width = 12, fig.height = 5, warning=F}
