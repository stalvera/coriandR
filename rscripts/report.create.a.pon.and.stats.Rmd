...
This report documents the creation of the Panel of Normals (PON) from sequencing runs of healthy individuals, which is later used for estimation of calculated karyotype and copy number variations (CNV) in hamatological malignances and solid tumours in research with `coriandR`.
