...
for(i in unique(pon$Chr)) {
  ...
  legend("right", c("amplif.", "deletion", "stalk", "centromer"), fill=c("white", "white", "#aaaa0055", "#00990055"), col=c("blue", "red", NA, NA), xpd=T, inset=c(-.1, 0), border=F, lty=0, pch=c(20, 20, NA, NA), cex=0.7)
}
```
