...
contigs$p_start = sapply(contigs$chr, function(c) min(c(cytobands$Start[cytobands$Chr == paste0('chr', c) & grepl('p', cytobands$Name)])))
contigs$p_end = sapply(contigs$chr, function(c) max(c(cytobands$End[cytobands$Chr == paste0('chr', c) & grepl('p', cytobands$Name)])))
contigs$q_start = sapply(contigs$chr, function(c) min(c(cytobands$Start[cytobands$Chr == paste0('chr', c) & grepl('q', cytobands$Name)])))
contigs$q_end = sapply(contigs$chr, function(c) max(c(cytobands$End[cytobands$Chr == paste0('chr', c) & grepl('q', cytobands$Name)])))
