...
for(c in 1:nrow(contigs)){
  if(sum(pon$aberration[pon$Chr == contigs$chr[c]] == 'amp')/sum(pon$Chr == contigs$chr[c]) > 0.8) print(paste(c, 'amplifiziert'))
  else if(sum(pon$aberration[pon$Chr == contigs$chr[c]] == 'del')/sum(pon$Chr == contigs$chr[c]) > 0.8) print(paste(c, 'deleted'))
  else if(sum(pon$aberration[pon$Chr == contigs$chr[c] & !is.na(pon$arm) & pon$arm == 'p'] == 'amp')/sum(pon$Chr == contigs$chr[c]) > 0.8) print(paste(c, 'p amplified'))
  else if(sum(pon$aberration[pon$Chr == contigs$chr[c] & !is.na(pon$arm) & pon$arm == 'p'] == 'del')/sum(pon$Chr == contigs$chr[c]) > 0.8) print(paste(c, 'p deleted'))
  else if(sum(pon$aberration[pon$Chr == contigs$chr[c] & !is.na(pon$arm) & pon$arm == 'q'] == 'amp')/sum(pon$Chr == contigs$chr[c]) > 0.8) print(paste(c, 'q amplified'))
  else if(sum(pon$aberration[pon$Chr == contigs$chr[c] & !is.na(pon$arm) & pon$arm == 'q'] == 'del')/sum(pon$Chr == contigs$chr[c]) > 0.8) print(paste(c, 'q deleted'))
}
```
